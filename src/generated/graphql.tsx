...
export type Get_InfoQuery = (
  { __typename?: 'query_root' }
  & { users: Array<(
    { __typename?: 'users' }
    & Pick<Users, 'school' | 'major' | 'concentration' | 'nickname' | 'auth0_id' | 'enroll' | 'planned_grad'>
  )> }
);
...
export type Get_CoursesQuery = (
  ...
  & { courses: Array<(
    { __typename?: 'courses' }
    & Pick<Courses, 'active' | 'term' | 'title' | 'code' | 'credits' | 'type' | 'campus' | 'writ_inten'>
  )> }
);
...
export type Update_UserMutation = (
  ...
  & { update_users?: Maybe<(
    ...
    & { returning: Array<(
      { __typename?: 'users' }
      & Pick<Users, 'nickname' | 'school' | 'major' | 'concentration' | 'enroll' | 'planned_grad'>
    )> }
  )> }
);

export type Increment_Course_EditsMutationVariables = Exact<{ [key: string]: never; }>;
...
export type Update_CourseMutation = (
  { __typename?: 'mutation_root' }
...
export type Update_Active_CoursesMutation = (
  { __typename?: 'mutation_root' }
  & { update_courses?: Maybe<(
    { __typename?: 'courses_mutation_response' }
    & Pick<Courses_Mutation_Response, 'affected_rows'>
...
export type Add_CourseMutation = (
  { __typename?: 'mutation_root' }
...
export type Add_Multiple_CoursesMutation = (
  { __typename?: 'mutation_root' }
  & { insert_courses?: Maybe<(
    { __typename?: 'courses_mutation_response' }
    & Pick<Courses_Mutation_Response, 'affected_rows'>
    & { returning: Array<(
      { __typename?: 'courses' }
      & Pick<Courses, 'term' | 'title' | 'code' | 'credits' | 'type' | 'campus' | 'writ_inten'>
    )> }
  )> }
);
...
export type Remove_All_CoursesMutationVariables = Exact<{ [key: string]: never; }>;


export type Remove_All_CoursesMutation = (
  { __typename?: 'mutation_root' }
  & { delete_courses?: Maybe<(
    { __typename?: 'courses_mutation_response' }
    & Pick<Courses_Mutation_Response, 'affected_rows'>
 ...
 * });
 */
export function useGet_InfoQuery(baseOptions?: Apollo.QueryHookOptions<Get_InfoQuery, Get_InfoQueryVariables>) {
        return Apollo.useQuery<Get_InfoQuery, Get_InfoQueryVariables>(Get_InfoDocument, baseOptions);
      }
export function useGet_InfoLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Get_InfoQuery, Get_InfoQueryVariables>) {
          return Apollo.useLazyQuery<Get_InfoQuery, Get_InfoQueryVariables>(Get_InfoDocument, baseOptions);
        }
export type Get_InfoQueryHookResult = ReturnType<typeof useGet_InfoQuery>;
export type Get_InfoLazyQueryHookResult = ReturnType<typeof useGet_InfoLazyQuery>;
export type Get_InfoQueryResult = Apollo.QueryResult<Get_InfoQuery, Get_InfoQueryVariables>;
 ...
 * });
 */
export function useGet_CoursesQuery(baseOptions?: Apollo.QueryHookOptions<Get_CoursesQuery, Get_CoursesQueryVariables>) {
        return Apollo.useQuery<Get_CoursesQuery, Get_CoursesQueryVariables>(Get_CoursesDocument, baseOptions);
      }
export function useGet_CoursesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Get_CoursesQuery, Get_CoursesQueryVariables>) {
          return Apollo.useLazyQuery<Get_CoursesQuery, Get_CoursesQueryVariables>(Get_CoursesDocument, baseOptions);
        }
export type Get_CoursesQueryHookResult = ReturnType<typeof useGet_CoursesQuery>;
export type Get_CoursesLazyQueryHookResult = ReturnType<typeof useGet_CoursesLazyQuery>;
export type Get_CoursesQueryResult = Apollo.QueryResult<Get_CoursesQuery, Get_CoursesQueryVariables>;
export const Update_UserDocument = gql`
    mutation UPDATE_USER($id: String!, $name: String!, $school: String!, $major: String!, $conc: String!, $enroll: Int!, $plannedGrad: String!) {
  update_users(
    where: {auth0_id: {_eq: $id}}
    _set: {nickname: $name, school: $school, major: $major, concentration: $conc, enroll: $enroll, planned_grad: $plannedGrad}
  ) {
    affected_rows
    returning {
      nickname
...
export const Increment_Course_EditsDocument = gql`
  ...
  update_users(where: {}, _inc: {course_edits: 1}) {
    ...
    `;
export type Increment_Course_EditsMutationFn = Apollo.MutationFunction<Increment_Course_EditsMutation, Increment_Course_EditsMutationVariables>;
 ...
 * });
 */
export function useIncrement_Course_EditsMutation(baseOptions?: Apollo.MutationHookOptions<Increment_Course_EditsMutation, Increment_Course_EditsMutationVariables>) {
        return Apollo.useMutation<Increment_Course_EditsMutation, Increment_Course_EditsMutationVariables>(Increment_Course_EditsDocument, baseOptions);
      }
export type Increment_Course_EditsMutationHookResult = ReturnType<typeof useIncrement_Course_EditsMutation>;
export type Increment_Course_EditsMutationResult = Apollo.MutationResult<Increment_Course_EditsMutation>;
export type Increment_Course_EditsMutationOptions = Apollo.BaseMutationOptions<Increment_Course_EditsMutation, Increment_Course_EditsMutationVariables>;
export const Update_CourseDocument = gql`
    mutation UPDATE_COURSE($old_title: String!, $active: Boolean!, $term: String!, $title: String!, $code: String!, $credits: numeric, $type: String!, $campus: String!, $writ_inten: Boolean!) {
  update_courses(
    where: {term: {_eq: $term}, title: {_eq: $old_title}}
    _set: {title: $title, active: $active, code: $code, credits: $credits, type: $type, campus: $campus, writ_inten: $writ_inten}
  ) {
    affected_rows
    returning {
      active
    ...
    `;
export type Update_CourseMutationFn = Apollo.MutationFunction<Update_CourseMutation, Update_CourseMutationVariables>;
 ...
 * });
 */
export function useUpdate_CourseMutation(baseOptions?: Apollo.MutationHookOptions<Update_CourseMutation, Update_CourseMutationVariables>) {
        return Apollo.useMutation<Update_CourseMutation, Update_CourseMutationVariables>(Update_CourseDocument, baseOptions);
      }
export type Update_CourseMutationHookResult = ReturnType<typeof useUpdate_CourseMutation>;
export type Update_CourseMutationResult = Apollo.MutationResult<Update_CourseMutation>;
export type Update_CourseMutationOptions = Apollo.BaseMutationOptions<Update_CourseMutation, Update_CourseMutationVariables>;
export const Update_Active_CoursesDocument = gql`
  ...
  update_courses(where: {term: {_eq: $term}}, _set: {active: $active}) {
    ...
    `;
export type Update_Active_CoursesMutationFn = Apollo.MutationFunction<Update_Active_CoursesMutation, Update_Active_CoursesMutationVariables>;
 ...
 * });
 */
export function useUpdate_Active_CoursesMutation(baseOptions?: Apollo.MutationHookOptions<Update_Active_CoursesMutation, Update_Active_CoursesMutationVariables>) {
        return Apollo.useMutation<Update_Active_CoursesMutation, Update_Active_CoursesMutationVariables>(Update_Active_CoursesDocument, baseOptions);
      }
export type Update_Active_CoursesMutationHookResult = ReturnType<typeof useUpdate_Active_CoursesMutation>;
export type Update_Active_CoursesMutationResult = Apollo.MutationResult<Update_Active_CoursesMutation>;
export type Update_Active_CoursesMutationOptions = Apollo.BaseMutationOptions<Update_Active_CoursesMutation, Update_Active_CoursesMutationVariables>;
export const Add_CourseDocument = gql`
    mutation ADD_COURSE($active: Boolean!, $term: String!, $title: String!, $code: String!, $credits: numeric, $type: String!, $campus: String!, $writ_inten: Boolean!) {
  insert_courses(
    objects: {active: $active, term: $term, title: $title, code: $code, credits: $credits, type: $type, campus: $campus, writ_inten: $writ_inten}
  ) {
    affected_rows
    returning {
      active
    ...
    `;
export type Add_CourseMutationFn = Apollo.MutationFunction<Add_CourseMutation, Add_CourseMutationVariables>;
 ...
 * });
 */
export function useAdd_CourseMutation(baseOptions?: Apollo.MutationHookOptions<Add_CourseMutation, Add_CourseMutationVariables>) {
        return Apollo.useMutation<Add_CourseMutation, Add_CourseMutationVariables>(Add_CourseDocument, baseOptions);
      }
export type Add_CourseMutationHookResult = ReturnType<typeof useAdd_CourseMutation>;
export type Add_CourseMutationResult = Apollo.MutationResult<Add_CourseMutation>;
export type Add_CourseMutationOptions = Apollo.BaseMutationOptions<Add_CourseMutation, Add_CourseMutationVariables>;
export const Add_Multiple_CoursesDocument = gql`
  ...
  insert_courses(objects: $objects) {
    ...
    `;
export type Add_Multiple_CoursesMutationFn = Apollo.MutationFunction<Add_Multiple_CoursesMutation, Add_Multiple_CoursesMutationVariables>;
 ...
 * });
 */
export function useAdd_Multiple_CoursesMutation(baseOptions?: Apollo.MutationHookOptions<Add_Multiple_CoursesMutation, Add_Multiple_CoursesMutationVariables>) {
        return Apollo.useMutation<Add_Multiple_CoursesMutation, Add_Multiple_CoursesMutationVariables>(Add_Multiple_CoursesDocument, baseOptions);
      }
export type Add_Multiple_CoursesMutationHookResult = ReturnType<typeof useAdd_Multiple_CoursesMutation>;
export type Add_Multiple_CoursesMutationResult = Apollo.MutationResult<Add_Multiple_CoursesMutation>;
export type Add_Multiple_CoursesMutationOptions = Apollo.BaseMutationOptions<Add_Multiple_CoursesMutation, Add_Multiple_CoursesMutationVariables>;
export const Remove_CourseDocument = gql`
  ...
  delete_courses(where: {term: {_eq: $term}, title: {_eq: $title}}) {
    ...
    `;
export type Remove_CourseMutationFn = Apollo.MutationFunction<Remove_CourseMutation, Remove_CourseMutationVariables>;
 ...
 * });
 */
export function useRemove_CourseMutation(baseOptions?: Apollo.MutationHookOptions<Remove_CourseMutation, Remove_CourseMutationVariables>) {
        return Apollo.useMutation<Remove_CourseMutation, Remove_CourseMutationVariables>(Remove_CourseDocument, baseOptions);
      }
...
export const Remove_All_CoursesDocument = gql`
  ...
  delete_courses(where: {}) {
    ...
    `;
export type Remove_All_CoursesMutationFn = Apollo.MutationFunction<Remove_All_CoursesMutation, Remove_All_CoursesMutationVariables>;
 ...
 * });
 */
export function useRemove_All_CoursesMutation(baseOptions?: Apollo.MutationHookOptions<Remove_All_CoursesMutation, Remove_All_CoursesMutationVariables>) {
        return Apollo.useMutation<Remove_All_CoursesMutation, Remove_All_CoursesMutationVariables>(Remove_All_CoursesDocument, baseOptions);
      }
export type Remove_All_CoursesMutationHookResult = ReturnType<typeof useRemove_All_CoursesMutation>;
export type Remove_All_CoursesMutationResult = Apollo.MutationResult<Remove_All_CoursesMutation>;
export type Remove_All_CoursesMutationOptions = Apollo.BaseMutationOptions<Remove_All_CoursesMutation, Remove_All_CoursesMutationVariables>;
